...
const colors = {
  gradients: {
    ...
    '3': 'linear-gradient(127.55deg, #141E30 3.73%, #243B55 92.26%)',
    '4': 'linear-gradient(135deg, #FCCF31 0%, #F55555 100%)',
    '5': 'linear-gradient(135deg, #FFD3A5 0%, #FD6585 100%)',
    '6': 'linear-gradient(135deg, #43CBFF 0%, #9708CC 100%)',
    '7': 'linear-gradient(135deg, #F6CEEC 0%, #D939CD 100%)',
    '8': 'linear-gradient(135deg, #F761A1 0%, #8C1BAB 100%)',
  ...
  shadows: {
    ...
    primary: '0px 1px 4px rgba(25, 117, 255, 0.25), 0px 3px 12px 2px rgba(25, 117, 255, 0.35)',
