...
const colors = {
  gradients: {
    // blue1: 'linear-gradient(135deg, #A492FF 0%, #2C41DA 100%)',
    // blue2: 'linear-gradient(135deg, #ABDCFF 0%, #0396FF 100%)',
    // blue3: 'linear-gradient(127.55deg, #141E30 3.73%, #243B55 92.26%)',
    // orange1: 'linear-gradient(135deg, #FCCF31 0%, #F55555 100%)',
    // orange2:
    //   'linear-gradient(0deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), linear-gradient(135deg, #FFD3A5 0%, #FD6585 100%)',
    ...
    '1': 'linear-gradient(135deg, #A492FF 0%, #3038A0 100%)',
    '2': 'linear-gradient(135deg, #ABDCFF 0%, #0396FF 100%)',
    '3': 'linear-gradient(127.55deg, #272F96 19.41%, #814B82 92.26%)',
    '4': 'linear-gradient(135deg, #FCCF31 0%, #F55555 100%)',
    '5': 'linear-gradient(0deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), linear-gradient(135deg, #FFD3A5 0%, #FD6585 100%)',
    '6': 'linear-gradient(135deg, #43CBFF 0%, #CC0885 100%, #6A19D2 100%, #9708CC 100%)',
    '7': 'linear-gradient(135deg, #F6CEEC 0%, #D939CD 100%)',
    '8': 'linear-gradient(135deg, rgba(225, 57, 57, 0.89) 0%, #CD187A 100%)',
    '9': 'linear-gradient(135deg, #FFF720 0%, #3CD500 100%)',
    '10': 'linear-gradient(100.66deg, #141E30 6.56%, #243B55 93.57%) ',
  },
  common: {
    grey: '#CCCCCC'
  },
...
export const DefaultTheme = createTheme({
  ...
  colors: {
    gradients: {
      ...
      '1': colors.gradients['1'],
      '2': colors.gradients['2'],
      '3': colors.gradients['3'],
      '4': colors.gradients['4'],
      '5': colors.gradients['5'],
      '6': colors.gradients['6'],
      '7': colors.gradients['7'],
      '8': colors.gradients['8'],
      '9': colors.gradients['9'],
      '10': colors.gradients['10'],
    },
    common: {
  ...
  components: {
    MuiBackdrop: {
      styleOverrides: {
        root: {
          backgroundColor: alpha(darken(themeColors.primaryAlt, 0.4), 0.5),
